      ...
      <footer className="footer section-padding">
        <div className="container">
          ...
          <div className="copyright">
            <p>&copy; 2026 Oficina Belas Artes. Todos os direitos reservados. <span style={{ opacity: 0.5, fontSize: "0.85em", fontFamily: "monospace", marginLeft: "10px" }}>V1.01.03</span></p>
